...
In the advanced tutorial, we will construct the same three outputs using the example of a Great Reed Warbler (18LX), this time including light and wind data. The workflow is very similar, we will see how to run the same procedure much faster. 
...
Here, we use an approach based on the threshold method and using a calibration of zenith angle (rather than time of sunrise). This approach is presented in more detail in [section 2.4 of Nussbaumer et al. (2023a)](https://besjournals.onlinelibrary.wiley.com/doi/10.1111/2041-210X.14043#mee314043-sec-0008-title)
