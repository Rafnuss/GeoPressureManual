...
<a href="https://trainset.raphaelnussbaumer.com/" target="_blank">https://trainset.raphaelnussbaumer.com/</a> 

Please report issues or bugs on the <a href="https://github.com/Rafnuss/trainset" target="_blank">Github repository</a>.

The original <a href="https://trainset.geocene.com/" target="_blank">TRAINSET app</a> therefore does not need to be used here.
::: 
...
Plotting this figure with <a href="https://plotly.com/r/" target="_blank">Plotly</a> allows you to zoom-in and pan to check the timeseries of each stationary period manually. Make sure each stationary period does not include any pressure measurement from a flight or a vertical movement by using the `discard` label on TRAINSET.
