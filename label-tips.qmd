...
![<small>Mis-labelled `flight` on acceleration data during low-activity flight typical of end-of-night migration.</small>](assets/labelling-tracks-1.png){width="100%" alt="Activity plot showing mislabeled flight data during low-activity gliding typical at end of night migration"}
...
![<small>Default pressure time series view at a breeding site.</small>](assets/labelling-tracks-3.png){width="100%" alt="Pressure timeseries plot showing default view where altitude changes are not immediately obvious"}
...
![<small>Zoomed view revealing an altitude change at the end of the breeding period.</small>](assets/labelling-tracks-4.png){width="100%" alt="Zoomed pressure timeseries plot clearly showing sudden pressure drop indicating altitude change"}
...
![<small>Edited time series after removing data points from altitude-change periods.</small>](assets/labelling-tracks-5.png){width="100%" alt="Pressure timeseries after removing datapoints during altitude change, showing only consistent elevation period"}
...
![<small>Extended daytime migration with unclear flight ending.</small>](assets/labelling-tracks-6.png){width="100%" alt="Activity plot showing extended migration into day with reduced intensity, making flight end unclear"}
...
![<small>Short migration halt with several hours of low activity.</small>](assets/labelling-tracks-7.png){width="100%" alt="Activity timeseries showing bird stopping for hours with ambiguous activity patterns"}
...
![<small>Pressure time series used to assess whether short halts are true stationary periods.</small>](assets/labelling-tracks-8.png){width="100%" alt="Pressure plot used to assess whether low activity periods represent true stationary periods or local movements"}
...
![<small>Ring Ouzel pressure time series showing daily altitudinal movements.</small>](assets/labelling-tracks-9.png){width="100%" alt="Complex pressure timeseries for Ring Ouzel showing daily altitudinal changes with unclear temporal vs spatial variation"}
...
![<small>Zoomed-out view to identify the most common elevation level.</small>](assets/labelling-tracks-10.png){width="100%" alt="Wider time view of pressure data to identify the most frequently used elevation level"}

![<small>Iterative editing to keep only data points at a consistent elevation.</small>](assets/labelling-tracks-11.png){width="100%" alt="Results of iterative editing process to retain only datapoints at consistent elevation"}
...
![<small>Eurasian Hoopoe pressure time series with continuous daily movement.</small>](assets/labelling-tracks-12.png){width="100%" alt="Sinusoidal pressure pattern showing continuous daily movement of Eurasian Hoopoe"}

This is the most challenging case as distinguishing temporal variation from altitudinal change is difficult.

![<small>Complex pattern requiring careful distinction between temporal variation and altitude change.</small>](assets/labelling-tracks-13.png){width="100%" alt="Challenging pressure timeseries requiring careful distinction between temporal variation and altitude changes"}
...
![<small>Final smoothed time series after multiple editing iterations.</small>](assets/labelling-tracks-14.png){width="100%" alt="Smoothed pressure timeseries after iterative editing with increased uncertainty for complex mountainous behavior"}
...
![<small>Case requiring full time-series discard due to no consistent elevation.</small>](assets/labelling-tracks-15.png){width="100%" alt="Ring Ouzel wintering site showing no consistent elevation, requiring complete timeseries discard"}
...
![<small>Geographic constraint: Atlas Mountains match the observed low-pressure values.</small>](assets/labelling-tracks-16.png){width="100%" alt="Map showing Atlas Mountains of Morocco as the geographic area matching observed low pressure values"}
