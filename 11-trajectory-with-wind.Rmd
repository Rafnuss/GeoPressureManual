...
`path2edge()` provides a very nice function to retrieve all information related to an edge (i.e., flight)
...
If you find anomalous flight speed, it might be worth checking if this/these flight(s) have been correctly labeled. 
