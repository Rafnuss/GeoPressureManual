...
```{r 21-geopressure-timeseries, cache=TRUE}
...
The `pressurepath` data.frame returned also contains the original pressure `pressure_tag` which can [be very helpful for labelling](labelling track) and the altitude of the bird corrected for the natural variation of pressure.
:::

```{r 21-pressurepath-create, cache=TRUE, warning = F}
