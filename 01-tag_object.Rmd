...
The raw data for this tag id should be stored in `"./data/raw-tag/CB619/"` following the default structure described in [GeoPressureTemplate](https://github.com/Rafnuss/GeoPressureTemplate#project-structure-file_folder). Because the data is recorded with a [Migrate Technology](https://www.migratetech.co.uk/) tag, we use the file extension `pressure_file = "*.deg"`.
