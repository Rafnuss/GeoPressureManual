...
Learn how to set-up your ECMWF account to be able to download ERA5 data on the [GeoPressureTemplate/Download Wind page](https://raphaelnussbaumer.com/GeoPressureManual/geopressuretemplate-wind.html#set-copernicus-credentials).
