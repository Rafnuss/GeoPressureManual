...
The first step is to create a ECMWF account on <a href="https://www.ecmwf.int/" target="_blank">www.ecmwf.int</a>. Once you have an account, you can log in on [cds.climate.copernicus.eu](https://cds.climate.copernicus.eu) and [retrieve your personal access token](https://cds.climate.copernicus.eu/profile) which should be saved as environment variables in your `.Renviron` using `usethis::edit_r_environ()`.
