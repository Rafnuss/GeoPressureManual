...
::: callout-note
The GeoPressureR Resources are optional, and even if you have not (yet!) analysed your data, it's worth publishing the data (maybe with an embargo?). The data package can always be updated once the analysis is done.
:::
