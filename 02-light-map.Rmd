...
We first define a grid on which to compute the probabilities. For ease of comparison with the pressure-derived map, we load the grid size and resolution from `pressure_prob` (computed [Pressure map | Computing mismatch maps](#computing-mismatch-maps)
