...
In case you have a lot of flight for which you need to download the data and don't want to block your console, you might consider using a [RStudio background job](https://solutions.rstudio.com/r/jobs/) which can be easily called with the [job package](https://lindeloev.github.io/job/):
